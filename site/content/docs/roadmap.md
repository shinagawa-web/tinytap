...
[TLS Compatibility]({{< relref "compatibility/tls" >}})), `v0.6.0`
...
[issue #19](https://github.com/shinagawa-web/tinytap/issues/19) on GitHub,
kept out of these docs so this stays focused on what tinytap does today.
